...
(custom-set-variables
 ...
 '(package-selected-packages
   '(## ace-window adaptive-wrap aggressive-indent bm company evil evil-collection flycheck free-keys goto-last-change key-chord lsp-mode magit minimap modus-themes rainbow-delimiters rust-mode vterm)))
(custom-set-faces
